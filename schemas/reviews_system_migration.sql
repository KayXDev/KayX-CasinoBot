...
-- Crear tablas para el sistema de reviews
...
CREATE TABLE IF NOT EXISTS reviews (
    ...
    -- Foreign key constraint (opcional, depende de tu estructura)
    -- FOREIGN KEY (user_id) REFERENCES user_profiles(discord_id) ON DELETE CASCADE
...
-- Insertar algunas reviews de ejemplo (opcional)
